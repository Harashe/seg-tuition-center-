        ...
        <section>
            ...
            <details>
                ...
                <details>
                    <summary>Lecture Notes</summary>
                    <ul>
                        <li><a href="materials/smns/BI110/LECTURE 1-Cell Structure.pdf" download>Lecture 1 (PDF)</a></li>
                        <li><a href="materials/smns/BI110/LECTURE 2.pdf" download>Lecture 2 (PDF)</a></li>
                    </ul>
                </details>
                <details>
                    <summary>Lecture Videos</summary>
                    <ul>
                        ...
                        <li><a href="https://www.youtube.com/watch?v=video8" target="_blank">Lecture Video 2</a></li>
                    </ul>
                </details>
                <details>
                    <summary>Past Papers</summary>
                    <ul>
                        <li><a href="materials/smns/biology_past_paper_1.pdf" download>Past Paper 1 (PDF)</a></li>
                    </ul>
                </details>
            </details>
        </section>
